...
class QuotesSpider(scrapy.Spider):
  ...
  database="url_automation")
    ...
    mycursor.execute("SELECT * FROM bulk_quill_bank where featured_image is null and bqt_id = 30")
    ...
    def parse(self, response):
        ...
        self.mycursor.execute("SELECT * FROM bulk_quill_template where bqt_id=30")
